...
<body>
	...
	<section id="container">
		...
		<?php
			// Paginador
			$sql_registe = mysqli_query($conection,"SELECT count(*) as total_registro FROM practica WHERE estatus = 1");
			...
			$query = mysqli_query($conection,"SELECT * FROM practica WHERE estatus = 1 ORDER BY fecha_inicio DESC LIMIT $desde,$por_pagina");
